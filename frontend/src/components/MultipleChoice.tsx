  ...
  return (
    <Card className="mb-6 bg-card border-border shadow-sm relative">
      ...
      <ExplanationDialog 
        ...
        answerExplanation={`Correct Answer: A\nBoth Sykes in Text 1 and the scholars in Text 2 recognize that John Fletcher has a distinctive writing style. Text 1 mentions that "Fletcher had a distinct style in his other plays, so much so that lines with that style were considered sufficient evidence of Fletcher's authorship." Text 2 supports this by stating that scholars can determine authorship "on the basis of style," indicating they can distinguish Fletcher's contributions from Shakespeare's.`}
      />
    </Card>
  );
};